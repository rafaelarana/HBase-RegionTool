...
public class NonUniformRegionNormalizer implements RegionNormalizer {

    private static final Log LOG = LogFactory.getLog(NonUniformRegionNormalizer.class);
    ...
    private static final String NORMALIZER_HOT_MAX_KEY_PROPERTY = "hbase.normalizer.nonuniform.hot.max.factor";
    private static final String NORMALIZER_WARM_MIN_KEY_PROPERTY = "hbase.normalizer.nonuniform.warm.min.factor";
    private static final String NORMALIZER_WARM_MAX_KEY_PROPERTY = "hbase.normalizer.nonuniform.warm.max.factor";
    private static final String NORMALIZER_COLD_MIN_KEY_PROPERTY = "hbase.normalizer.nonuniform.cold.min.factor";
    private static final String NORMALIZER_COLD_MAX_KEY_PROPERTY = "hbase.normalizer.nonuniform.cold.max.factor";
    ...
    private static final double DEFAULT_MAX_REGION_FACTOR = 2.;
    ...
    private double coldMaxRegionsFactor;
    private double warmMinRegionsFactor;
    private double warmMaxRegionsFactor;
    private double hotMinRegionsFactor;
    private double hotMaxRegionsFactor;
    ...
    public void setMasterServices(MasterServices masterServices) {
        ...
        // Sets the number of regions intervals (min,max) for each stage
        this.coldMinRegionsFactor = configuration.getDouble(NORMALIZER_COLD_MIN_KEY_PROPERTY, DEFAULT_MIN_REGION_FACTOR);
        this.coldMaxRegionsFactor = configuration.getDouble(NORMALIZER_COLD_MAX_KEY_PROPERTY, DEFAULT_MAX_REGION_FACTOR);
        this.warmMinRegionsFactor = configuration.getDouble(NORMALIZER_WARM_MIN_KEY_PROPERTY, DEFAULT_MIN_REGION_FACTOR);
        this.warmMaxRegionsFactor = configuration.getDouble(NORMALIZER_WARM_MAX_KEY_PROPERTY, DEFAULT_MAX_REGION_FACTOR);
        this.hotMinRegionsFactor = configuration.getDouble(NORMALIZER_HOT_MIN_KEY_PROPERTY, DEFAULT_MIN_REGION_FACTOR);
        this.hotMaxRegionsFactor = configuration.getDouble(NORMALIZER_HOT_MAX_KEY_PROPERTY, DEFAULT_MAX_REGION_FACTOR);
    ...
    private List<NormalizationPlan> getPlansForHot(TableName table, List<HRegionInfo> tableRegions, int numberOfRS) {
        ...
        return getPlans( table, tableRegions,  avgRegionSize,  minNumberOfRegions, maxNumberOfRegions);
    }
    ...
    private List<NormalizationPlan> getPlansForCold(TableName table, List<HRegionInfo> tableRegions,int numberOfRS) {
        ...
        int numberOfRegions = tableRegions.size();
        int maxNumberOfRegions = (int) (coldMaxRegionsFactor * numberOfRS);
    ...
    private List<NormalizationPlan> getPlans(TableName table, List<HRegionInfo> tableRegions, double  avgRegionSize, int minNumberOfRegions, int maxNumberOfRegions) {
    ...
    private List<NormalizationPlan> getPlansForMaxBound(TableName table, List<HRegionInfo> tableRegions, double avgRegionSize, int maxNumberOfRegions) {
